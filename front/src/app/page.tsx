...
import { Plus, Trash2, ChevronLeft, ChevronRight, Database, Cpu, FileText } from 'lucide-react';
  ...
  return (
    <>
      ...
      <Dialog open={isNewTaskDialogOpen} onOpenChange={setIsNewTaskDialogOpen}>
        <DialogContent className="glass-card-dialog max-w-md">
          <DialogHeader>
            <DialogTitle className="text-xl font-semibold glow-text flex items-center gap-2">
              <Plus className="h-5 w-5 text-purple-400" />
              新建任务
            </DialogTitle>
            <DialogDescription className="text-muted-foreground">
              填写任务的基本信息，创建新的数字孪生任务
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                className="bg-white/5 border-purple-400/60 focus:border-purple-400 focus:ring-purple-400/20"
                autoFocus
              />
            </div>
            <div className="space-y-2">
              ...
              <Textarea
                ...
                className="bg-white/5 border-purple-400/60 focus:border-purple-400 focus:ring-purple-400/20 resize-none"
                rows={4}
              />
            </div>
          </div>
