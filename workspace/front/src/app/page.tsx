          ...
          <div className="mb-6 flex gap-4">
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
              ...
              <DialogContent className="glass-card sm:max-w-[500px]">
                <DialogHeader>
                  <DialogTitle className="text-2xl font-semibold glow-text">新建任务</DialogTitle>
                ...
                <div className="grid gap-4 py-4">
                  <div className="grid gap-2">
                    ...
                    <Input
                      ...
                      className="border-purple-400/60 bg-white/5 focus:border-purple-400 focus:ring-2 focus:ring-purple-400/20"
                    />
                  </div>
                  <div className="grid gap-2">
                    ...
                    <Textarea
                      ...
                      rows={4}
                      className="border-purple-400/60 bg-white/5 focus:border-purple-400 focus:ring-2 focus:ring-purple-400/20 resize-none"
                    />
                  </div>
                </div>
